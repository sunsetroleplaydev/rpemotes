        ...
        if #args > 0 then
            ...
            if (distance ~= -1 and distance < 3) then
                if RP.Shared[emotename] ~= nil then
                    ...
                    TriggerServerEvent("ServerEmoteRequest", GetPlayerServerId(target), false, emotename)
...
RegisterNetEvent("BypassClientEmoteRequestReceive")
AddEventHandler("BypassClientEmoteRequestReceive", function(emotename, etype, target)
    requestedemote = emotename
