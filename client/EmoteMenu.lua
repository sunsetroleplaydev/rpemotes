...
function AddEmoteMenu(menu)
    local submenu = _menuPool:AddSubMenu(menu, Config.Languages[lang]['emotes'], Config.Languages[lang]['emote_desc'], Menuthing, Menuthing, Menuthing)
    submenu:SetMenuWidthOffset(60)
    ...
    local dancemenu = _menuPool:AddSubMenu(submenu, Config.Languages[lang]['danceemotes'], Config.Languages[lang]['dance_desc'], Menuthing, Menuthing, Menuthing)
    dancemenu:SetMenuWidthOffset(60)
    local animalmenu
    if Config.AnimalEmotesEnabled then
        animalmenu = _menuPool:AddSubMenu(submenu, Config.Languages[lang]['animalemotes'], Config.Languages[lang]['animal_desc'], Menuthing, Menuthing, Menuthing)
        animalmenu:SetMenuWidthOffset(60)
        table.insert(EmoteTable, Config.Languages[lang]['animalemotes'])
    end
    local propmenu = _menuPool:AddSubMenu(submenu, Config.Languages[lang]['propemotes'], Config.Languages[lang]['prop_desc'], Menuthing, Menuthing, Menuthing)
    ...
    if Config.SharedEmotesEnabled then
        sharemenu = _menuPool:AddSubMenu(submenu, Config.Languages[lang]['shareemotes'],
            Config.Languages[lang]['shared_desc'], Menuthing, Menuthing, Menuthing)
            sharemenu:SetMenuWidthOffset(60)
        shareddancemenu = _menuPool:AddSubMenu(sharemenu, Config.Languages[lang]['sharedanceemotes'], Config.Languages[lang]['shareddance_desc'], Menuthing, Menuthing, Menuthing)
            shareddancemenu:SetMenuWidthOffset(60)
    ...
    if not Config.SqlKeybinding then
        ...
        favmenu = _menuPool:AddSubMenu(submenu, Config.Languages[lang]['favoriteemotes'], Config.Languages[lang]['favoriteinfo'], Menuthing, Menuthing, Menuthing)
        favmenu:SetMenuWidthOffset(60)
    ...
    if Config.SharedEmotesEnabled then
        sharemenu.OnItemSelect = function(sender, item, index)
            if ShareTable[index] ~= 'none' then
                ...
                if (distance ~= -1 and distance < 3) then
                    ...
                    TriggerServerEvent("ServerEmoteRequest", GetPlayerServerId(target), false, ShareTable[index])
        ...
        shareddancemenu.OnItemSelect = function(sender, item, index)
            ...
            if (distance ~= -1 and distance < 3) then
                ...
                TriggerServerEvent("ServerEmoteRequest", GetPlayerServerId(target),  false, DanceTable[index], 'Dances')
                SimpleNotify(Config.Languages[lang]['sentrequestto'] .. GetPlayerName(target))
            else
                SimpleNotify(Config.Languages[lang]['nobodyclose'])
            end
...
if Config.Search then
    ...
    function EmoteMenuSearch(lastMenu)
        ...
        if input ~= nil then
            ...
            if #results > 0 then
                local searchMenu = _menuPool:AddSubMenu(lastMenu, string.format(Config.Languages[lang]['searchmenudesc'], #results, input), "Search Results", Menuthing, Menuthing, Menuthing)
                searchMenu:SetMenuWidthOffset(60)
                ...
                if Config.SharedEmotesEnabled then
                    sharedDanceMenu = _menuPool:AddSubMenu(searchMenu, Config.Languages[lang]['sharedanceemotes'], Config.Languages[lang]['shared_desc'], Menuthing, Menuthing, Menuthing)
                    sharedDanceMenu:SetMenuWidthOffset(60)
                end
                ...
                searchMenu.OnItemSelect = function(sender, item, index)
                    ...
                    elseif data.table == "Shared" then
                        ...
                        if (distance ~= -1 and distance < 3) then
                            ...
                            TriggerServerEvent("ServerEmoteRequest", GetPlayerServerId(target), false, data.name)
                            SimpleNotify(Config.Languages[lang]['sentrequestto'] .. GetPlayerName(target))
                        else
                            SimpleNotify(Config.Languages[lang]['nobodyclose'])
                        end
                    ...
                    if #sharedDanceMenu.Items > 0 then
                        ...
                        sharedDanceMenu.OnItemSelect = function(sender, item, index)
                            ...
                            if (distance ~= -1 and distance < 3) then
                                ...
                                TTriggerServerEvent("ServerEmoteRequest", GetPlayerServerId(target), false, data.name, 'Dances')
                                SimpleNotify(Config.Languages[lang]['sentrequestto'] .. GetPlayerName(target))
                            else
                                SimpleNotify(Config.Languages[lang]['nobodyclose'])
                            end
...
function AddWalkMenu(menu)
    local submenu = _menuPool:AddSubMenu(menu, Config.Languages[lang]['walkingstyles'], Config.Languages[lang]['walking_desc'], Menuthing, Menuthing, Menuthing)
    submenu:SetMenuWidthOffset(60)
...
function AddFaceMenu(menu)
    local submenu = _menuPool:AddSubMenu(menu, Config.Languages[lang]['moods'], Config.Languages[lang]['moods_desc'], Menuthing, Menuthing, Menuthing)
    submenu:SetMenuWidthOffset(60)
