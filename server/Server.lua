...
RegisterNetEvent("ServerEmoteRequest", function(target, bypass, emotename, etype)
    ...
    if not bypass then 
        ...
        TriggerClientEvent("BypassClientEmoteRequestReceive", target, emotename, etype, source)
    end
end)
